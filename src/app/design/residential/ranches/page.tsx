// location: src/app/design/residential/ranches/page.tsx
import type { Metadata } from "next";
import Link from "next/link";

export const metadata: Metadata = {
  title: "Ranches | Residential Design | ELI Land Design",
  description:
    "Ranch residential landscape design. Entries, drives, pasture edges, water management, and durable planting.",
  alternates: { canonical: "/design/residential/ranches" },
};
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className={`${card} overflow-hidden`}>
            <div className="relative aspect-[16/10] w-full">
              <img
                src="/images/design/residential/ranches/hero.jpg"
                alt="Ranches placeholder"
          ...
          <div className={`${card} p-6`}>
            ...
            <p className="mt-3 text-sm md:text-[15px] leading-relaxed text-black/70">
              Gallery stub for owner review. Next step: a categorized grid for entries, drives,
              water management, planting, and detail vignettes.
            </p>
          </div>
        </div>
      </div>
