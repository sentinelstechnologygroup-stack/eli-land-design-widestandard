// location: src/app/design/residential/renderings/page.tsx
import type { Metadata } from "next";
import Link from "next/link";

export const metadata: Metadata = {
  title: "Renderings | Residential Design | ELI Land Design",
  description:
    "Residential renderings gallery. Concept visuals used to align on materials, planting character, and spatial intent.",
  alternates: { canonical: "/design/residential/renderings" },
};
...
export default function ResidentialRenderingsPage() {
  return (
    <div className={shell}>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className={`${card} overflow-hidden`}>
            <div className="relative aspect-[16/10] w-full">
              <img
                src="/images/design/residential/renderings/hero.jpg"
                alt="Residential renderings placeholder"
          ...
          <div className={`${card} p-6`}>
            ...
            <p className="mt-3 text-sm md:text-[15px] leading-relaxed text-black/70">
              Gallery stub for owner review. Next step: a renderings library with categories
              and a lightbox viewer that keeps navigation fast and clean.
            </p>
          </div>
        </div>
      </div>
