// location: src/app/design/commercial/multifamily/page.tsx
...
export const metadata: Metadata = {
  title: "Multifamily | Commercial Design | ELI Land Design",
  description:
    "Multifamily commercial landscape design gallery. Courtyards, pool decks, entries, and community amenities.",
  alternates: { canonical: "/design/commercial/multifamily" },
};
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm md:text-[15px] leading-relaxed text-black/70">
                Community + amenity spaces—courtyards, pool decks, entries, lighting, and planting strategy.
              </p>
            </div>
        ...
        <section className="mt-8 grid gap-6 md:grid-cols-2">
          <div className={`${card} overflow-hidden`}>
            <div className="relative aspect-[16/10] w-full">
              <Image
                src="/images/design/commercial/multifamily/hero.jpg"
                alt="Multifamily placeholder"
                fill
          ...
          <div className={`${card} p-7`}>
            ...
            <h2 className="mt-3 text-xl md:text-2xl font-semibold tracking-tight text-black/90">
              Categories + captions later.
            </h2>
            <p className="mt-4 text-sm md:text-[15px] leading-relaxed text-black/70">
              Next: add a categorized image grid (entries, amenities, planting, lighting) with captions and a clean lightbox.
            </p>
          </div>
        </section>
      </div>
